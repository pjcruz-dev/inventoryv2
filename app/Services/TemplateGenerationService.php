    ...
    private function getTemplateHeaders(string $module): array
    {
        $headers = [
            'assets' => [
                ...
                'status' => ['name' => 'Status', 'required' => true, 'type' => 'enum', 'options' => ['Available', 'Maintenance', 'Pending Confirmation', 'Active', 'For Disposal'], 'default' => 'Available', 'description' => 'Current asset status'],
                'movement' => ['name' => 'Movement', 'required' => true, 'type' => 'enum', 'options' => ['Return', 'New Arrival', 'Deployed'], 'default' => 'New Arrival', 'description' => 'Asset movement type'],
