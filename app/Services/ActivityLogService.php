...
class ActivityLogService
{
    ...
    public function logActivity(
        ...
        return Log::create([
            ...
            'metadata' => $metadata,
            'session_id' => $this->request->request()->hasSession() ? request()->session()->getId() : null,
    ...
    public function logSystemEvent(string $eventType, string $description, array $additionalData = []): ?Log
    {
        ...
        return Log::create([
            ...
            'action_details' => $actionDetails,
            'metadata' => $this->getRequestMetadata(),
            'session_id' => $this->request->session() ? $this->request->request()->hasSession() ? request()->session()->getId() : null : null,
            'request_method' => $this->request->method(),
            'request_url' => $this->request->fullUrl(),
            'request_parameters' => $this->filterSensitiveData($this->request->all()),
            'browser_name' => $this->agent->browser(),
