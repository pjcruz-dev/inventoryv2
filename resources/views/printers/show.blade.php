            ...
            <form id="assignForm" method="POST" action="{{ route('assets.assign', $printer->asset) }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Enter assignment details, location, purpose, or any specific instructions for this printer assignment..."></textarea>
                        <small class="form-text text-muted">Include details like: location, purpose, special instructions, or printer configuration notes</small>
                    </div>
                </div>
